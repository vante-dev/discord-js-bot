...
module.exports = {
    ...
    execute: async (client, guild) => { 
        ...
        const invite  =await guild.channels.cache.filter(channel => channel.type !== "category").first().createInvite(false,84600,0, false)
        ...
        new ButtonBuilder()
            ...
            .setURL(invite ? "https://discord.gg/" + invite.code : "https://vante.dev/")
        );
