...
const {Time: { format_time }} = require("../")
...
module.exports = class newSpotify {
   ...
   return this;
    ...
    async build() {
      ...
      const start_format = format_time(this.start > this.end ? this.end : this.start);
      const end_format = format_time(this.end);
