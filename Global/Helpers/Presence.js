...
function updatePresence(client) {
  let message = client.system.Client.Presence.Message[0] ? client.system.Client.Presence.Message[Math.floor(Math.random() * client.system.Client.Presence.Message.length)] : "Developed By Vante";
